...
class PlayerHigherThanAvgTableModel extends AbstractTableModel {
	...
	private String[] columnNames = { "Player ID", "Name", "Position" };
	private List<Player> players;

	public PlayerHigherThanAvgTableModel(List<Player> thePlayers) {
		players = thePlayers;
	}
